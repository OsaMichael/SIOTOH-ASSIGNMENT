...
namespace SiotohBlog.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Success:
                    ...
                    return RedirectToAction("RgisteredUser", "Blog");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                // BY DEFAULT WE HAVE ADMIN, ANY OTHER REGISTERATION IS FOR USER.
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["message"] = string.Format("{0} has been registered.", user.FirstName + "" + user.LastName);
        ...
        public async Task<ActionResult> CreateUser(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("UserList", "Blog");
                }
                AddErrors(result);
            }
